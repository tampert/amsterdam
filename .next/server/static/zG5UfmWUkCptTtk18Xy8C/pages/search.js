...
/* harmony import */ var react_infinite_scroller__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(53);
...
/* harmony import */ var react_transition_group__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(54);
...
/* harmony import */ var _app_global_Theme__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(0);
/* harmony import */ var _app_services__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(10);
...
function (_Component) {
  ...
  _createClass(SearchPage, null, [{
    ...
    value: function () {
      ...
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(_ref) {
        var query, _BoatService$getUrlPa, defaultFilters, defaultParams, response;
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                query = _ref.query;
                _BoatService$getUrlPa = _app_services__WEBPACK_IMPORTED_MODULE_9__[/* BoatService */ "a"].getUrlParams(query), defaultFilters = _BoatService$getUrlPa.defaultFilters, defaultParams = _BoatService$getUrlPa.defaultParams;
                _context.next = 4;
                return _app_services__WEBPACK_IMPORTED_MODULE_9__[/* BoatService */ "a"].getAll(defaultParams);
  ...
  function SearchPage(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(SearchPage).call(this, props)); // Default States

    _this.state = {
      busy: true,
      hasMore: props.response.items.length == _app_global__WEBPACK_IMPORTED_MODULE_11__[/* PAGE_SIZE */ "f"],
  ...
  _createClass(SearchPage, [{
    ...
    value: function componentWillMount() {
      var _this$props = this.props,
          boatFilters = _this$props.boatFilters,
          defaultFilters = _this$props.defaultFilters,
          defaultParams = _this$props.defaultParams,
          boatParams = _this$props.boatParams;
      this.props.setFilters(_objectSpread({}, boatFilters, defaultFilters));
      this.props.setParams(_objectSpread({}, boatParams, defaultParams));
      this.setState({
        busy: false
      });
    }
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2(nextProps) {
        var response;
            ...
            switch (_context2.prev = _context2.next) {
              case 0:
                if (nextProps.response != this.props.response) {
                  ...
                  this.setState({
                    filteredResults: response.items,
                    hasMore: response.items.length == _app_global__WEBPACK_IMPORTED_MODULE_11__[/* PAGE_SIZE */ "f"],
                    busy: false
                  });
      ...
      return function componentWillReceiveProps(_x2) {
    ...
    value: function () {
      ...
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee3() {
        var _this$state, filteredResults, hasMore, busy, boatParams, response;

        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _this$state = this.state, filteredResults = _this$state.filteredResults, hasMore = _this$state.hasMore, busy = _this$state.busy;
                boatParams = this.props.boatParams;
                ...
                _context3.next = 8;
                return _app_services__WEBPACK_IMPORTED_MODULE_9__[/* BoatService */ "a"].getAll(boatParams);

              case 8:
                response = _context3.sent;
                this.setState({
                  filteredResults: _toConsumableArray(filteredResults).concat(_toConsumableArray(response.items)),
                  hasMore: response.items.length == _app_global__WEBPACK_IMPORTED_MODULE_11__[/* PAGE_SIZE */ "f"],
                  busy: false
                });
    ...
    value: function render() {
      ...
      var _this$state2 = this.state,
          filteredResults = _this$state2.filteredResults,
          hasMore = _this$state2.hasMore;
      var _this$props2 = this.props,
          loading = _this$props2.loading,
          sorting = _this$props2.boatFilters.sorting,
          response = _this$props2.response;
      return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_app_components_layout__WEBPACK_IMPORTED_MODULE_6__[/* DefaultLayout */ "a"], null, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", {
        className: styled_jsx_style__WEBPACK_IMPORTED_MODULE_1___default.a.dynamic([["3010851363", [_app_global_Theme__WEBPACK_IMPORTED_MODULE_8__[/* COLORS */ "a"].primary, _app_global_Theme__WEBPACK_IMPORTED_MODULE_8__[/* COLORS */ "a"].primary, _app_global_Theme__WEBPACK_IMPORTED_MODULE_8__[/* COLORS */ "a"].primary]]]) + " " + "search-page ".concat(loading && "search-page--loading")
      }, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_app_components_ui__WEBPACK_IMPORTED_MODULE_7__[/* Loading */ "g"], {
        show: loading,
        text: "Loading Boats...",
        className: "search-page__loading"
      }), react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", {
        className: styled_jsx_style__WEBPACK_IMPORTED_MODULE_1___default.a.dynamic([["3010851363", [_app_global_Theme__WEBPACK_IMPORTED_MODULE_8__[/* COLORS */ "a"].primary, _app_global_Theme__WEBPACK_IMPORTED_MODULE_8__[/* COLORS */ "a"].primary, _app_global_Theme__WEBPACK_IMPORTED_MODULE_8__[/* COLORS */ "a"].primary]]]) + " " + "container"
      }, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", {
        className: styled_jsx_style__WEBPACK_IMPORTED_MODULE_1___default.a.dynamic([["3010851363", [_app_global_Theme__WEBPACK_IMPORTED_MODULE_8__[/* COLORS */ "a"].primary, _app_global_Theme__WEBPACK_IMPORTED_MODULE_8__[/* COLORS */ "a"].primary, _app_global_Theme__WEBPACK_IMPORTED_MODULE_8__[/* COLORS */ "a"].primary]]]) + " " + "row"
      }, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", {
        className: styled_jsx_style__WEBPACK_IMPORTED_MODULE_1___default.a.dynamic([["3010851363", [_app_global_Theme__WEBPACK_IMPORTED_MODULE_8__[/* COLORS */ "a"].primary, _app_global_Theme__WEBPACK_IMPORTED_MODULE_8__[/* COLORS */ "a"].primary, _app_global_Theme__WEBPACK_IMPORTED_MODULE_8__[/* COLORS */ "a"].primary]]]) + " " + "col-xs-12"
      }, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", {
        className: styled_jsx_style__WEBPACK_IMPORTED_MODULE_1___default.a.dynamic([["3010851363", [_app_global_Theme__WEBPACK_IMPORTED_MODULE_8__[/* COLORS */ "a"].primary, _app_global_Theme__WEBPACK_IMPORTED_MODULE_8__[/* COLORS */ "a"].primary, _app_global_Theme__WEBPACK_IMPORTED_MODULE_8__[/* COLORS */ "a"].primary]]]) + " " + "search-page__filter"
      }, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("span", {
        className: styled_jsx_style__WEBPACK_IMPORTED_MODULE_1___default.a.dynamic([["3010851363", [_app_global_Theme__WEBPACK_IMPORTED_MODULE_8__[/* COLORS */ "a"].primary, _app_global_Theme__WEBPACK_IMPORTED_MODULE_8__[/* COLORS */ "a"].primary, _app_global_Theme__WEBPACK_IMPORTED_MODULE_8__[/* COLORS */ "a"].primary]]]) + " " + "search-page__filter__l"
      }, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_app_components_ui__WEBPACK_IMPORTED_MODULE_7__[/* CustomSelect */ "d"], {
        value: sorting,
        onChange: function onChange(value) {
          _this3.props.setFilter("sorting", value);

          _this3.props.setParam("order_by", value);
        }
      }, _app_global__WEBPACK_IMPORTED_MODULE_11__[/* FIELDS */ "d"].SORTING.map(function (v) {
        return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("option", {
          key: v.id,
          value: v.id,
          className: styled_jsx_style__WEBPACK_IMPORTED_MODULE_1___default.a.dynamic([["3010851363", [_app_global_Theme__WEBPACK_IMPORTED_MODULE_8__[/* COLORS */ "a"].primary, _app_global_Theme__WEBPACK_IMPORTED_MODULE_8__[/* COLORS */ "a"].primary, _app_global_Theme__WEBPACK_IMPORTED_MODULE_8__[/* COLORS */ "a"].primary]]])
        }, v.label);
      }))), react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("span", {
        className: styled_jsx_style__WEBPACK_IMPORTED_MODULE_1___default.a.dynamic([["3010851363", [_app_global_Theme__WEBPACK_IMPORTED_MODULE_8__[/* COLORS */ "a"].primary, _app_global_Theme__WEBPACK_IMPORTED_MODULE_8__[/* COLORS */ "a"].primary, _app_global_Theme__WEBPACK_IMPORTED_MODULE_8__[/* COLORS */ "a"].primary]]]) + " " + "search-page__filter__m"
      }, response.total_count, " Boats to rent in Location"), react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", {
        className: styled_jsx_style__WEBPACK_IMPORTED_MODULE_1___default.a.dynamic([["3010851363", [_app_global_Theme__WEBPACK_IMPORTED_MODULE_8__[/* COLORS */ "a"].primary, _app_global_Theme__WEBPACK_IMPORTED_MODULE_8__[/* COLORS */ "a"].primary, _app_global_Theme__WEBPACK_IMPORTED_MODULE_8__[/* COLORS */ "a"].primary]]]) + " " + "search-page__filter__r"
      }, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("a", {
        href: "#",
        className: styled_jsx_style__WEBPACK_IMPORTED_MODULE_1___default.a.dynamic([["3010851363", [_app_global_Theme__WEBPACK_IMPORTED_MODULE_8__[/* COLORS */ "a"].primary, _app_global_Theme__WEBPACK_IMPORTED_MODULE_8__[/* COLORS */ "a"].primary, _app_global_Theme__WEBPACK_IMPORTED_MODULE_8__[/* COLORS */ "a"].primary]]])
      }, "Grid"), react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("a", {
        href: "#",
        className: styled_jsx_style__WEBPACK_IMPORTED_MODULE_1___default.a.dynamic([["3010851363", [_app_global_Theme__WEBPACK_IMPORTED_MODULE_8__[/* COLORS */ "a"].primary, _app_global_Theme__WEBPACK_IMPORTED_MODULE_8__[/* COLORS */ "a"].primary, _app_global_Theme__WEBPACK_IMPORTED_MODULE_8__[/* COLORS */ "a"].primary]]])
      }, "List"), react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("a", {
        href: "#",
        className: styled_jsx_style__WEBPACK_IMPORTED_MODULE_1___default.a.dynamic([["3010851363", [_app_global_Theme__WEBPACK_IMPORTED_MODULE_8__[/* COLORS */ "a"].primary, _app_global_Theme__WEBPACK_IMPORTED_MODULE_8__[/* COLORS */ "a"].primary, _app_global_Theme__WEBPACK_IMPORTED_MODULE_8__[/* COLORS */ "a"].primary]]])
      }, "Map"))))), filteredResults.length == 0 && react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", {
        className: styled_jsx_style__WEBPACK_IMPORTED_MODULE_1___default.a.dynamic([["3010851363", [_app_global_Theme__WEBPACK_IMPORTED_MODULE_8__[/* COLORS */ "a"].primary, _app_global_Theme__WEBPACK_IMPORTED_MODULE_8__[/* COLORS */ "a"].primary, _app_global_Theme__WEBPACK_IMPORTED_MODULE_8__[/* COLORS */ "a"].primary]]]) + " " + "search-page__noresult"
      }, "sorry we could not find any boats for your search criteria..."), react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(react_infinite_scroller__WEBPACK_IMPORTED_MODULE_4___default.a, {
        threshold: 300,
        hasMore: !loading && hasMore,
        loader: react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_app_components_ui__WEBPACK_IMPORTED_MODULE_7__[/* Loading */ "g"], {
          key: "loading",
          show: true,
      ...
      }, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(react_transition_group__WEBPACK_IMPORTED_MODULE_5__["CSSTransitionGroup"], {
        className: "row",
        component: "div",
        transitionName: "boat",
        transitionEnterTimeout: 500,
        transitionLeaveTimeout: 300
      }, filteredResults.map(function (data, i) {
        return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", {
          key: "boat-".concat(data.guid),
          className: styled_jsx_style__WEBPACK_IMPORTED_MODULE_1___default.a.dynamic([["3010851363", [_app_global_Theme__WEBPACK_IMPORTED_MODULE_8__[/* COLORS */ "a"].primary, _app_global_Theme__WEBPACK_IMPORTED_MODULE_8__[/* COLORS */ "a"].primary, _app_global_Theme__WEBPACK_IMPORTED_MODULE_8__[/* COLORS */ "a"].primary]]]) + " " + "col-lg-3 col-md-4 col-sm-6 col-xs-12"
        ...
        styleId: "3010851363",
        css: [".search-page.__jsx-style-dynamic-selector{position:relative;}", ".search-page.search-page--loading.__jsx-style-dynamic-selector:before{opacity:1;visibility:visible;pointer-event:none;}", ".search-page.__jsx-style-dynamic-selector:before{content:'';display:block;-webkit-transition:all 200ms;transition:all 200ms;opacity:0;visibility:hidden;pointer-events:none;z-index:4;position:absolute;left:0;top:0;width:100%;height:100%;background:rgba(255,255,255,0.6);}", ".search-page.__jsx-style-dynamic-selector .search-page__loading{position:absolute;z-index:6;left:0;right:0;margin:0 auto;top:350px;}", ".search-page__filter.__jsx-style-dynamic-selector{position:relative;font-size:16px;line-height:20px;color:".concat(_app_global_Theme__WEBPACK_IMPORTED_MODULE_8__[/* COLORS */ "a"].primary, ";height:60px;display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-flex-direction:row;-ms-flex-direction:row;flex-direction:row;-webkit-box-pack:start;-webkit-justify-content:flex-start;-ms-flex-pack:start;justify-content:flex-start;-webkit-align-items:center;-webkit-box-align:center;-ms-flex-align:center;align-items:center;}"), ".search-page__filter__m.__jsx-style-dynamic-selector{text-align:center;position:absolute;left:50%;top:50%;-webkit-transform:translate(-50%,-50%);-ms-transform:translate(-50%,-50%);transform:translate(-50%,-50%);}", ".search-page__filter__r.__jsx-style-dynamic-selector{margin-left:auto;}", ".search-page__filter__r.__jsx-style-dynamic-selector a.__jsx-style-dynamic-selector{-webkit-transition:all 200ms;transition:all 200ms;color:".concat(_app_global_Theme__WEBPACK_IMPORTED_MODULE_8__[/* COLORS */ "a"].primary, ";margin-left:20px;position:relative;}"), ".search-page__filter__r.__jsx-style-dynamic-selector a.__jsx-style-dynamic-selector:before{content:'|';position:absolute;left:-10px;width:1px;height:100%;top:-1.5px;}", ".search-page__filter__r.__jsx-style-dynamic-selector a.__jsx-style-dynamic-selector:first-child.__jsx-style-dynamic-selector:before{display:none;}", ".search-page__filter__r.__jsx-style-dynamic-selector a.__jsx-style-dynamic-selector:hover{opacity:0.7;}", ".search-page__noresult.__jsx-style-dynamic-selector{text-align:center;padding:20px 0;color:".concat(_app_global_Theme__WEBPACK_IMPORTED_MODULE_8__[/* COLORS */ "a"].primary, ";font-weight:nold;font-size:16px;}"), ".search-page__headlines__list.__jsx-style-dynamic-selector{display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-flex-direction:row;-ms-flex-direction:row;flex-direction:row;-webkit-box-pack:'justify';-webkit-justify-content:'space-between';-ms-flex-pack:'justify';justify-content:'space-between';-webkit-align-items:'flex-start';-webkit-box-align:'flex-start';-ms-flex-align:'flex-start';align-items:'flex-start';}", ".boat-enter.__jsx-style-dynamic-selector{opacity:0.01;-webkit-transform:scale(0.6);-ms-transform:scale(0.6);transform:scale(0.6);}", ".boat-enter.boat-enter-active.__jsx-style-dynamic-selector{opacity:1;-webkit-transform:scale(1);-ms-transform:scale(1);transform:scale(1);-webkit-transition:all 400ms ease;transition:all 400ms ease;}", ".boat-leave.__jsx-style-dynamic-selector{opacity:1;}", ".boat-leave.boat-leave-active.__jsx-style-dynamic-selector{display:none;}", "@media all and (max-width:768px){.search-page__filter__m.__jsx-style-dynamic-selector{-webkit-flex:1;-ms-flex:1;flex:1;position:relative;left:0;top:0;-webkit-transform:none;-ms-transform:none;transform:none;text-align:left;}.search-page__filter__l.__jsx-style-dynamic-selector{-webkit-order:2;-ms-flex-order:2;order:2;}.search-page__filter__r.__jsx-style-dynamic-selector{display:none;}}"],
        dynamic: [_app_global_Theme__WEBPACK_IMPORTED_MODULE_8__[/* COLORS */ "a"].primary, _app_global_Theme__WEBPACK_IMPORTED_MODULE_8__[/* COLORS */ "a"].primary, _app_global_Theme__WEBPACK_IMPORTED_MODULE_8__[/* COLORS */ "a"].primary]
      }));
    }
  }]);
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    setLoading: function setLoading(loading) {
      dispatch(_app_redux_actions__WEBPACK_IMPORTED_MODULE_10__[/* Boat */ "a"].setLoading(loading));
    },
    setParams: function setParams(params) {
    ...
    setParam: function setParam(key, value) {
      dispatch(_app_redux_actions__WEBPACK_IMPORTED_MODULE_10__[/* Boat */ "a"].setQueryParam(key, value));
    },
    setFilters: function setFilters(filters) {
    ...
    setFilter: function setFilter(key, value) {
      dispatch(_app_redux_actions__WEBPACK_IMPORTED_MODULE_10__[/* Boat */ "a"].setFilter(key, value));
    }
  };
};

/* harmony default export */ __webpack_exports__["default"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_3__["connect"])(MapsToProps, mapDispatchToProps)(SearchPage));

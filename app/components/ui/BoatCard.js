            ...
            <a className="boat-card" target="_blank">
                ...
                <div className="boat-card__content">
                    ...
                    <div className="boat-card__footer">
                        ...
                        <Button link={false} className="boat-card__footer__button" color="black--outline">View Details</Button>
                    </div>
                </div>
                <style jsx>{`
                    ...
                    .boat-card:hover .boat-card__img span { transform: scale(1.1) }
                    ...
                    .boat-card__title { font-size: 18px; line-height: 23px; color: ${COLORS.black}; font-weight: 500; margin-bottom: 6px; white-space: nowrap; text-overflow: ellipsis; overflow: hidden } 
                    ...
                    .boat-card__category { -webkit-line-clamp: 2; display: -webkit-box; overflow: hidden; -webkit-box-orient: vertical; margin: 15px 0 10px 0; font-size: 13px; line-height: 15px; color: ${COLORS.lightgray}; }
                    ...
                    .boat-card__total-price { display: inline-block; vertical-align: middle; font-size: 17px; line-height: 22px; color: ${COLORS.lightgreen}; font-weight: bold;  }
                    ...
                    .boat-card__discount { display: inline-block; margin-right: 6px; vertical-align: middle; background-color: ${COLORS.lightgreen}; color: #ffffff; font-size: 10px; font-weight: bold; line-height: 13px; height: 15px; border-radius: 2px; padding: 2px 6px; }
                    ...
                    @media all and (max-width: 768px) {
                        ...
                        .boat-card__title { display: flex; flex-direction: row; justify-content: flex-start; align-items; center; line-height: 19px; font-weight: 400;}
